...
TCHAR serviceLongName[] = _T("NaomiCore auth service");
TCHAR serviceDescription[] = _T("NaomiCore World of Warcraft emulator auth service");
/*
...
int main(int argc, char** argv)
{
    ...
    Trinity::Banner::Show("Wotlk 2026",
        ...
        []()
        {
            TC_LOG_INFO("server.authserver", "[Using] › Config File {}.", sConfigMgr->GetFilename());
            TC_LOG_INFO("server.authserver", "[Using] › SSL Version: {}", OPENSSL_VERSION_TEXT);
			...
			TC_LOG_INFO("server.authserver", " --------------------------- LOADED -------------------------------");
			TC_LOG_INFO("server.authserver", " ");
        }
    );
