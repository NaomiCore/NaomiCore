...
namespace fs = boost::filesystem;
    ...
    #define _TRINITY_CORE_CONFIG  "NaomiWotlk.conf"
#endif

#ifndef _TRINITY_CORE_CONFIG_DIR
    #define _TRINITY_CORE_CONFIG_DIR "NaomiWotlk.conf.d"
#endif
...
TCHAR serviceLongName[] = _T("NaomiCore world service");
TCHAR serviceDescription[] = _T("NaomiCore World of Warcraft emulator world service");
/*
...
int main(int argc, char** argv)
{
    ...
    Trinity::Banner::Show("Wotlk 2026",
        [](char const* text)
        {
        ...
        []()
        {
            TC_LOG_INFO("server.worldserver", "[Using] › Config File {}.", sConfigMgr->GetFilename());
            TC_LOG_INFO("server.worldserver", "[Using] › SSL Version: {}", OPENSSL_VERSION_TEXT);
    ...
    if (int coreStuckTime = sConfigMgr->GetIntDefault("MaxCoreStuckTime", 60))
    {
        ...
        TC_LOG_INFO("server.worldserver", "Starting up AntiFreeze ({} seconds max stuck time)...", coreStuckTime);
    }

       TC_LOG_INFO("server.worldserver", " ");
       TC_LOG_INFO("server.worldserver", "  ╭────────────────────────────────────────────────────────────╮");
       TC_LOG_INFO("server.worldserver", "  │            POWERED BY NAOMICORE 2026 - UKRAINE             │");
       TC_LOG_INFO("server.worldserver", "  ├────────────────────────────────────────────────────────────┤");
       TC_LOG_INFO("server.worldserver", "  │                                                            │");
       TC_LOG_INFO("server.worldserver", "  │  » World of Warcraft: Wrath of the Lich King  :: [Ready]   │");
       TC_LOG_INFO("server.worldserver", "  │  » Clean code but powerful TOOLS - Gossip menu option      │");
       TC_LOG_INFO("server.worldserver", "  │  » Email: xnaomicore@gmail.com   - Classic wow Redesign    │");
       TC_LOG_INFO("server.worldserver", "  ╰────────────────────────────────────────────────────────────╯");
       TC_LOG_INFO("server.worldserver", " ");
