...
// 48714 - Twisting Blade (Quest 12050)
class spell_q12050_twisting_blade : public SpellScript
{
    PrepareSpellScript(spell_q12050_twisting_blade);
    ...
    void Register() override
    {
        OnCheckCast += SpellCheckCastFn(spell_q12050_twisting_blade::CheckCast);
    }
};
...
void AddSC_quest_spell_scripts()
{
	...
	RegisterSpellScript(spell_q12050_twisting_blade);
}
