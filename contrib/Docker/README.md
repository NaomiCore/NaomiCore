...
The instructions below expect a basic knowledge of how to configure NaomiCore and how to use Docker.
...
1. Copy the .conf files from the NaomiCore GitHub repository to a local folder which will be passed on as a mapped volume to Docker.
...
1. Set the "DataDir" config in NaomiWotlk.conf to `"/trinity/data"`
